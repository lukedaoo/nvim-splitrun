...
---@field focus boolean?
---@field force_split_type string?  -- "vsplit" | "split" | nil
local M = {
...
function M.define_commands()
    local function make_splitrun_command(name, split_type)
    ...
    -- New forced-split commands with bookmark support
    make_splitrun_command("SplitrunV", "vsplit")
    make_splitrun_command("SplitrunS", "split")
end
